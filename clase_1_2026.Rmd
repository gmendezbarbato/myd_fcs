...
.center[
```{r form, out.width = "500px"}
knitr::include_graphics("ima/form.jpeg")
```
]
...
--
  ...
  - [UMAD - Mirador DESCA](https://bancodedatos-fcs.shinyapps.io/Mirador-DESCA-app/)
...
<!--   - [Ejemplo de flujo](https://gmendezbarbato.github.io/myd_fcs/whisper_manini.html) -->
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-1.png")
```
]

.left[.small-text[Fuente: http://www.mclibre.org]]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-2.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-3.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-4.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-5.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-6.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-7.png")
```
]
...
.center[
```{r, out.width = "700px"}
knitr::include_graphics("ima/trabajo-tiempo-8.png")
```
]
...
-	Llaudet, E., & Imai, K. (2022). *Data analysis for social science: A friendly and practical introduction.* Princeton University Press. Introducción.
  - [Enlace](https://eva.fcs.udelar.edu.uy/pluginfile.php/227512/mod_folder/content/0/3.%20Data%20Analysis%20for%20Social%20Science/Introducci%C3%B3n.%20Data%20Analysis%20for%20Social%20Science%20%28Elena%20Llaudet%2C%20Kosuke%20Imai%29.pdf)
  - [Enlace texto completo](https://eva.fcs.udelar.edu.uy/pluginfile.php/227512/mod_folder/content/0/3.%20Data%20Analysis%20for%20Social%20Science/Data%20Analysis%20for%20Social%20Science%20%28libro%20completo%20ingl%C3%A9s%29.pdf)
...
### Data analysis for social science... (Intro)
...
### Ahora ingresen/descarguen la carpeta de eva Codigo Clase 1 y abran el archivo codigo_1_2026.R 
...
- En R el signo **>** (prompt) indica que el interprete está pronto para recibir órdenes.

- Si luego de dar una orden en lugar de aparecer nuevamente el prompt aparece el signo de **+** indica que hay una orden incompleta.

- Para salir de ese ciclo, debe escapar con **Esc**

- Para ejecutar una línea de código pueden usar el botón de "Run" arriba a la derecha o -más cómodo- `ctrl + enter`

- Errores y Warnings:
  - Leerlos, entenderlos y solucionarlos es una de las mejores maneras de aprender (usar los foros!)
  - Que no aparezcan no quiere decir que lo que hicimos sea correcto.
...
- [**Operadores en R**](https://gmendezbarbato.github.io/myd_fcs/documentos-markdown/operadores.html)
...
> Para comprender la programación en R, dos lemas son útiles:
...
En R  podemos almacenar los resultados en objetos, creados mediante asignaciones (`<-`). En este caso, guardemos el valor y luego lo imprimimos. 
...
- También veremos `factores`, que si bien formalmente son integer, por sus características, los vamos a usar mucho.
---
...
## ¿Por qué importan los tipos y clases? 
Cuidado, el intérprete (R), no sabe nuestro idioma, no es una herramienta conversacional (no es chatgpt)

.codefontmaschico[
```{r ej7b32bis, echo = TRUE, error=TRUE}
obj_1 <- "diez"
...
- *¿Qué pasó acá?*
R tratará de dar una respuesta, lo que hizo fue coercionar a un vector númerico, pero "diez" no es un número, entonces el dato es un NA
...
Además de la bibliografía del curso, para el caso de este dialecto en particular, les recomiendo ver este curso.

- [Curso de Tidyverse](https://jhudatascience.org/tidyversecourse/intro.html)
