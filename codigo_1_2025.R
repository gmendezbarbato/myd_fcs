##----------------------------------------------------------------------------##
#                                                                              #
#    Medición y Diseño 2025 | Carneiro y Méndez                                #
...
5*9*45 # Se imprime el resultado

anio <- 5*9*45 # Se crea un objeto

anio # Se imprime el objeto creado

(anio <- 5*9*45) # Se crea un objeto y se imprime (se usa poco)
